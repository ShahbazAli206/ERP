...
/**
 * Vertical timeline of a sales order's `StatusHistory` entries — one dot per
 * status transition with who made it, when, and any note. Scoped copy of
 * Procurement's `status-timeline.tsx` pattern (see that module's report) —
 * kept as its own component per this module's isolation boundary rather than
 * a shared import, since Procurement is being built/iterated concurrently.
 */
